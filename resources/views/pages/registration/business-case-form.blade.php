      ...
      <form action="" method="post">
        ...
        <div class="registration-content">
          ...
          <div class="registration-input-group">
            <p class="group-header">TEAM INFO &mdash;</p>
          ...
          <div class="registration-input-group">
            <p class="group-header">TEAM MEMBER 1 &mdash;</p>
            
            <div class="registration-input">
              <input type="text" class="form-input" name="name2" id="name2" placeholder=' ' required/>
            ...
            <div class="registration-input-row">
              <div class="registration-input-col">
                <div class="registration-radio-wrapper">
                  ...
                  <label>
                      <span class='radio-description'>Male</span>
                      <input type="radio" class="individual-radio" name="gender2" value="Male" checked>
                      <span class='radio-button'><span></span></span>
                  </label>
                  <label>
                      <span class='radio-description'>Female</span>
              ...
              <div class="registration-input-col flex-justify-center">
                <div class="registration-input">
                  <input type="number" class="form-input display-inline-block" name="age2" id="age2" placeholder=' ' min="0" max="100" required/> 
            ...
            <div class="registration-input">
              <input type="email" class="form-input" name="email2" id="email2" placeholder=' ' required/>
            ...
            <div class="registration-input-row">
              <div class="registration-input-col">
                <div class="registration-input">
                  <input type="text" class="form-input" name="line2" id="line2" placeholder=' ' required/>
                  <label class="text-label" for="line2">Line</label>
                </div>
              </div>
              <div class="registration-input-col">
                <div class="registration-input">
                  <input type="text" class="form-input" name="phone2" id="phone2" placeholder=' ' required/>
            ...
            <div class="registration-input">
              <input type="text" class="form-input" name="major2" id="major2" placeholder=' ' required/>
            ...
            <div class="registration-input-row">
              <div class="registration-input-col">
                <div class="registration-input">
                  <input type="text" class="form-input" name="batch2" id="batch2" placeholder=' ' required/>
          ...
          <div class="registration-input-group">
            <p class="group-header">TEAM MEMBER 2 &mdash;</p>
            
            <div class="registration-input">
              <input type="text" class="form-input" name="name3" id="name3" placeholder=' ' required/>
            ...
            <div class="registration-input-row">
              <div class="registration-input-col">
                <div class="registration-radio-wrapper">
                  ...
                  <label>
                      <span class='radio-description'>Male</span>
                      <input type="radio" class="individual-radio" name="gender3" value="Male" checked>
                      <span class='radio-button'><span></span></span>
                  </label>
                  <label>
                      <span class='radio-description'>Female</span>
              ...
              <div class="registration-input-col flex-justify-center">
                <div class="registration-input">
                  <input type="number" class="form-input display-inline-block" name="age3" id="age3" placeholder=' ' min="0" max="100" required/> 
            ...
            <div class="registration-input">
              <input type="email" class="form-input" name="email3" id="email3" placeholder=' ' required/>
            ...
            <div class="registration-input-row">
              <div class="registration-input-col">
                <div class="registration-input">
                  <input type="text" class="form-input" name="line3" id="line3" placeholder=' ' required/>
                  <label class="text-label" for="line3">Line</label>
                </div>
              </div>
              <div class="registration-input-col">
                <div class="registration-input">
                  <input type="text" class="form-input" name="phone3" id="phone3" placeholder=' ' required/>
            ...
            <div class="registration-input-row">
              <div class="registration-input-col">
                <div class="registration-input">
                  <input type="text" class="form-input" name="batch3" id="batch3" placeholder=' ' required/>
